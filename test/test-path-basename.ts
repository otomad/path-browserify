...
tape("path.basename", (t) => {
	t.strictEqual(path.basename(__filename), "test-path-basename.ts");
	t.strictEqual(path.basename(__filename, ".ts"), "test-path-basename");
...
// tape("path.win32.basename", { skip: true }, t => {
...
tape("On unix a backslash is just treated as any other character.", (t) => {
	t.strictEqual(
...
tape("POSIX filenames may include control characters", (t) => {
